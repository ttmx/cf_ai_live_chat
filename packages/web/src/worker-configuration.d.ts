/* eslint-disable */
// Generated by Wrangler by running `wrangler types ./src/worker-configuration.d.ts` (hash: ff063cc793da98414f51f0849a0a4ab3)
...
declare namespace Cloudflare {
	...
	interface Env {
		WS_URL: "https://ws-chat.tteles.dev";
		PUBLIC_BASE_URL: string;
		WS: Fetcher /* chat-durable-object */;
		ASSETS: Fetcher;
	}
}
